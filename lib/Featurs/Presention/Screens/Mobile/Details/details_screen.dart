...
import 'package:tamwen_web/Featurs/Presention/Screens/Mobile/Details/update_product.dart';
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  CustomText(text: ' ${AppStrings.name}  ${users.name}'),
                ],
              ),
            ),
            Expanded(
